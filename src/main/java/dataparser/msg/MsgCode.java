...
public class MsgCode {
	...
	public static String MSG_CODE_STRING_TAB = "\t";
	public static String MSG_CODE_STRING_SUCCESS = "SUCCESS";

	public static String MSG_CODE_FILE_PATH = "C:\\";
	public static String MSG_CODE_FILE_DEFAULT_SPLITTER = "\t";
	public static String MSG_CODE_FILE_EXTENSION_TXT = ".txt";
