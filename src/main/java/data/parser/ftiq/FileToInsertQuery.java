...
public class FileToInsertQuery extends QueryTemplate implements CommonInterface {
	...
	protected String parseTextFile() {
		TextToInsertQueryTask textTask = (TextToInsertQueryTask) ParserFactory.createTask(ParseType.FTIQ, FileType.TEXT, splitter);
...
//		return resultString.toString();
	...
	protected String parseExcelFile() {
		ExcelToInsertQueryTask excelTask = (ExcelToInsertQueryTask) ParserFactory.createTask(ParseType.FTIQ, FileType.EXCEL, splitter);
